...
>
> 相关Wiki：[数据库总览](../技术架构/通威农发-数据库总览.md) | [EBS-DIM接口](../技术架构/ebs-dim/README.md) | [运营指标体系](../KPI指标/README.md))
## 报表概况
...
详见 [[通威农发/技术架构/通威农发-数据库总览|通威农发-数据库总览]] 中的视图BUG章节。
...
- [[通威农发/行业知识/饲料行业知识|feed-industry-knowledge]]
- [[通威农发/行业知识/饲料行业解决方案|feed-industry-solution]]
