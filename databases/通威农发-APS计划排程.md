...
APS（Advanced Planning & Scheduling，高级计划排程）模块是通威农发智能工厂的核心生产调度模块，覆盖从需求管理、计划排程、生产预算到物料需求的全链路业务。模块包括年/月/日计划管理、市场需求提报、物料需求计划、生产排程、能源预算、调料分配与审核、齐套检查、缺料跟踪、供应分类、工艺参数配置及开票未提货等业务功能。共包含 **35 张**数据表。
