...
> 数字化制造平台（MES）项目，四期实施覆盖车间执行、仓储管理、质量检验全流程

- [[久立项目-项目总览]] — 四期项目概述：背景、分期、组织架构、涉及区域、系统架构
- [[久立项目-项目章程与范围]] — 项目章程Ver10、项目范围定义
- [[久立项目-业务调研纪要]]
- [[久立项目-业务调研报告]] — 各期详细调研报告全文（冷轧/JCO/仓储/管件，273KB） — 各期调研提纲与会议纪要（一期冷轧/JCO/仓储、三期、四期）
- [[久立项目-业务痛点与需求]] — 各厂区痛点&需求汇总（JCO/冷轧/仓储/管件/精密/穿孔等）
- [[久立项目-蓝图方案-一期]] — 一期详细蓝图：冷轧一厂车间、JCO车间、辅料仓、成品仓
- [[久立项目-蓝图方案-三四期]] — 三四期蓝图：质检/精密/五厂/管件/原材料仓等
- [[久立项目-系统接口]] — MES↔SAP/OA↔SAP接口技术文档与接口清单
- [[久立项目-操作手册]] — IPC/PC/PDA端操作手册，18个功能模块操作指南
- [[久立项目-里程碑与验收]] — 各期里程碑阶段确认报告与验收报告
