...
- [[通威农发-数据库总览]] — 1,572张核心业务表结构，按19个模块分组
- [[通威农发-CPT报表分析]] — 30张CPT绩效报表分析经验
...
- [[培训-总览]] — 培训资料总索引（80个文件，含售前调研、课件、表格等）
- [[培训-WMS与MES测试方法论]] — WMS/MES用户验收测试方法论：场景化测试设计、数据集成要点
- [[培训-售前调研与行业报告]] — 售前调研纪要、行业知识讲义、技术趋势报告
- [[培训-实施方法论与课件体系]] — 实施方法论课件、培训课程体系、签到表模板
- [[培训-数字化转型周读-第一周]] — 从工具革命到决策革命：智能制造转型之路
- [[培训-数字化转型周读-第二周]] — 德国工业4.0、美国AMP、中国制造2025对比研究
- [[培训-数字化转型周读-第三至六周]] — 制造业数字化转型案例集与学习方法论
- [[培训-数据分析入门]] — 数据分析方法、业务数据案例、图表选型指南
- [[培训-欧软云MES产品介绍]] — 面向零散制造行业的云MES系统产品介绍
- [[培训-管件原材料检验功能说明书]] — 管件原材料检验全流程信息化管理功能设计
- [[培训-精益生产-标准化工作手册]] — 丰田TPS标准化工作理论框架与TWI核心技能
- [[培训-金蝶Cloud同步对照表]] — ERP与WMS数据同步字段映射关系
- [[功能设计快速上手培训]] — 从业务需求到功能设计的5步快速上手培训
...
- [[document-processing-tools]] — 文档处理工具汇总：Excel/PDF/Word/PPT，OfficeCLI一站式处理
...
- [[frontend-slides-presentation]] — 零依赖 HTML 演示文稿生成，100vh 适配与动画丰富
- [[claude-api-development]] — 使用 Anthropic SDK 构建 Claude API 应用的最佳实践
- [[mcp-server-development]] — Model Context Protocol 服务器开发指南
- [[systematic-debugging]] — 4阶段根因分析方法论：问题复现、假设验证、根因定位、修复验证
- [[test-driven-development]] — RED-GREEN-REFACTOR 循环的 TDD 实践
...
- [[text2kpi-optimization]] — Text2KPI NL2API 系统：V1六项优化方案 + V2四层架构/五步Pipeline/查询编排/推理可观测
...
## 数据库
- [[通威农发-数据库总览]] — 通威农发项目数据库结构总览，包含1,407张核心业务表的模块分布与索引
- [[通威农发-LM精益管理]] — 精益管理模块：8D问题解决/安环/标准化，154张表
- [[通威农发-WMS仓储管理]] — 仓储管理模块：入库/出库/库存/拣货/盘点，167张表
- [[通威农发-MES生产执行]] — 生产执行模块：配料/生产工单/报工/清洗/打包，158张表
- [[通威农发-QMS质量管理]] — 质量管理模块：检验/质检/不合格品/追溯，120张表
- [[通威农发-EDO设备管理]] — 设备管理模块：设备全生命周期/维保/故障，119张表
- [[通威农发-IIoT工业物联网]] — 工业物联网：设备数据采集/监控，76张表
- [[通威农发-报表预处理中间表]] — 报表预处理中间表：ST+LM_ST统计中间表，84张表
- [[通威农发-MI制造智能]] — 制造智能：预警/测点/数据填报/IDA，38张表
- [[通威农发-APS计划排程]] — 高级计划排程，35张表
- [[通威农发-E2D与数据同步]] — EBS与外围系统数据交换，28张表
- [[通威农发-MBM物料BOM与配方]] — 物料BOM与配方管理，36张表
- [[通威农发-Measure计量管理]] — 称重/计量/校准，25张表
- [[通威农发-公共与基础模块]] — Common/RBAC/工作流/国际化/多租户等，127张表
- [[通威农发-基础数据与主数据]] — 物料/包装/配件/资源/客商等主数据，53张表
- [[通威农发-资产管理EAM与设备]] — 资产管理与设备维护，15张表
- [[通威农发-物流执行LES与WHM]] — 物流执行与仓库辅助，19张表
- [[通威农发-技术参数与其他]] — 技术参数/报表/流程/数据交换，90张表
- [[通威农发-其他小模块]] — 小型功能模块汇总，61张表
