...
2. `通威农发/通威农发-项目治理.md` — 项目治理体系（章程/SOW/7层组织架构/滚动计划/3类会议/34份受控文档/人员管理/验收标准）
3. `通威农发/通威农发-业务调研.md` — 6大业务域调研汇总（计划管理3流程/生产管理10流程/设备管理13流程+质量/仓库/EBS待补充）
...
**更新页面**：
- `通威农发/通威农发-业务调研.md` — 补充仓库管理14流程（CK001-CK014）+ EBS解耦11流程（ERP01-ERP11）+ 主数据管理现状 + 生产完工入库关键流程 + EBS解耦优化需求
...
- Phase 2：蓝图方案
- 2026-06-03: 创建 [[通威农发/通威农发-蓝图方案-仓储与EBS集成]] — 从物资管理V1.0和EBS集成V0.1蓝图文档提取，覆盖26个MA子流程和55个EBS解耦接口
