...
DESC: 测试-炒锅联调方案
============================================================
[/body/p[@paraId=648A637E]] MES系统与炒制设备PLC的联调测试方案
[/body/p[@paraId=2C17CF89]] • 测试目标
[/body/p[@paraId=288190CA]] MES系统与炒制设备的联动控制，验证MES系统与设备PLC的交付方案的流程。
[/body/p[@paraId=0D9C5CF1]] 
[/body/p[@paraId=42A64EEF]] • 测试地点和测试对象
[/body/p[@paraId=012F084F]] 测试地点：B栋1楼、2楼；
[/body/p[@paraId=045E7E3E]] 测试对象：牛油2#线炒锅（定量罐、1-4#炒锅、落料灌）和炼油锅。
[/body/p[@paraId=381DC533]] 备注：需在2#线未生产的情况下进行测试。
